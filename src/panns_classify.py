...
_LABEL_MAP = {
    ...
    # FX / Ruido / Outros
    "Vehicle":                        ("outro", "Outro", "Other"),
    "Motor vehicle (road)":           ("outro", "Outro", "Other"),
    "Car":                            ("outro", "Outro", "Other"),
    "Engine":                         ("outro", "Outro", "Other"),
    "White noise":                    ("outro", "Noise", "Noise"),
    "Pink noise":                     ("outro", "Noise", "Noise"),
    "Noise":                          ("outro", "Noise", "Noise"),
    "Wind":                           ("outro", "Outro", "Other"),
    "Rain":                           ("outro", "Outro", "Other"),
    "Water":                          ("outro", "Outro", "Other"),
    "Explosion":                      ("outro", "Outro", "Other"),
    "Gunshot, gunfire":               ("outro", "Outro", "Other"),
    "Bird":                           ("outro", "Outro", "Other"),
    "Animal":                         ("outro", "Outro", "Other"),
}
